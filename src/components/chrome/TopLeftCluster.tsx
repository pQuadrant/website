...
export function TopLeftCluster({ content }: TopLeftClusterProps) {
  return (
    <div className="flex flex-col gap-[7px] font-mono">
      ...
      <p className="flex flex-col gap-[7px] text-label text-fg-1 text-shadow-glow-1 row:flex-row row:items-baseline row:gap-[14px]">
      ...
      <p className="text-subhead text-fg-3 text-shadow-glow-3">
        {content.server}
      </p>
    </div>
  );
